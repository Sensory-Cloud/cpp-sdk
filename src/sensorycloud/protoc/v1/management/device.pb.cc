...
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, sizeof(::sensory::api::v1::management::EnrollDeviceRequest)},
  { 10, -1, sizeof(::sensory::api::v1::management::DeviceResponse)},
  { 17, -1, sizeof(::sensory::api::v1::management::DeviceGetWhoAmIRequest)},
};
...
inline void EnrollDeviceRequest::SharedCtor() {
name_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
deviceid_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
tenantid_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
credential_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
...
void EnrollDeviceRequest::InternalSwap(EnrollDeviceRequest* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      &tenantid_, GetArenaForAllocation(),
      &other->tenantid_, other->GetArenaForAllocation()
  );
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      &credential_, GetArenaForAllocation(),
      &other->credential_, other->GetArenaForAllocation()
  );
...
inline void DeviceGetWhoAmIRequest::SharedCtor() {
}

DeviceGetWhoAmIRequest::~DeviceGetWhoAmIRequest() {
  // @@protoc_insertion_point(destructor:sensory.api.v1.management.DeviceGetWhoAmIRequest)
  if (GetArenaForAllocation() != nullptr) return;
  SharedDtor();
  _internal_metadata_.Delete<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>();
}

inline void DeviceGetWhoAmIRequest::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
}

void DeviceGetWhoAmIRequest::ArenaDtor(void* object) {
  DeviceGetWhoAmIRequest* _this = reinterpret_cast< DeviceGetWhoAmIRequest* >(object);
  (void)_this;
}
void DeviceGetWhoAmIRequest::RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena*) {
}
void DeviceGetWhoAmIRequest::SetCachedSize(int size) const {
  _cached_size_.Set(size);
}

void DeviceGetWhoAmIRequest::Clear() {
// @@protoc_insertion_point(message_clear_start:sensory.api.v1.management.DeviceGetWhoAmIRequest)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
const char* DeviceGetWhoAmIRequest::_InternalParse(const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    ::PROTOBUF_NAMESPACE_ID::uint32 tag;
    ptr = ::PROTOBUF_NAMESPACE_ID::internal::ReadTag(ptr, &tag);
...
::PROTOBUF_NAMESPACE_ID::uint8* DeviceGetWhoAmIRequest::_InternalSerialize(
    ::PROTOBUF_NAMESPACE_ID::uint8* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:sensory.api.v1.management.DeviceGetWhoAmIRequest)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:sensory.api.v1.management.DeviceGetWhoAmIRequest)
  return target;
}

size_t DeviceGetWhoAmIRequest::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:sensory.api.v1.management.DeviceGetWhoAmIRequest)
  size_t total_size = 0;
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData DeviceGetWhoAmIRequest::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSizeCheck,
    DeviceGetWhoAmIRequest::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*DeviceGetWhoAmIRequest::GetClassData() const { return &_class_data_; }

void DeviceGetWhoAmIRequest::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message*to,
                      const ::PROTOBUF_NAMESPACE_ID::Message&from) {
  static_cast<DeviceGetWhoAmIRequest *>(to)->MergeFrom(
      static_cast<const DeviceGetWhoAmIRequest &>(from));
}


void DeviceGetWhoAmIRequest::MergeFrom(const DeviceGetWhoAmIRequest& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:sensory.api.v1.management.DeviceGetWhoAmIRequest)
  GOOGLE_DCHECK_NE(&from, this);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
void DeviceGetWhoAmIRequest::CopyFrom(const DeviceGetWhoAmIRequest& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:sensory.api.v1.management.DeviceGetWhoAmIRequest)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool DeviceGetWhoAmIRequest::IsInitialized() const {
  return true;
}

void DeviceGetWhoAmIRequest::InternalSwap(DeviceGetWhoAmIRequest* other) {
  using std::swap;
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
}
