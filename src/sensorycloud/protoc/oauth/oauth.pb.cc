...
#include "sensorycloud/protoc/oauth/oauth.pb.h"
...
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, sizeof(::sensory::api::oauth::TokenRequest)},
  { 7, -1, sizeof(::sensory::api::oauth::SignTokenRequest)},
  { 14, -1, sizeof(::sensory::api::oauth::WhoAmIRequest)},
  { 19, -1, sizeof(::sensory::api::oauth::WhoAmIResponse)},
  { 26, -1, sizeof(::sensory::api::oauth::PublicKeyRequest)},
  { 32, -1, sizeof(::sensory::api::oauth::PublicKeyResponse)},
};
...
inline void SignTokenRequest::SharedCtor() {
subject_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
scope_ = 0;
}
...
inline void WhoAmIRequest::SharedCtor() {
}

WhoAmIRequest::~WhoAmIRequest() {
  // @@protoc_insertion_point(destructor:sensory.api.oauth.WhoAmIRequest)
  if (GetArenaForAllocation() != nullptr) return;
  SharedDtor();
  _internal_metadata_.Delete<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>();
}

inline void WhoAmIRequest::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
}

void WhoAmIRequest::ArenaDtor(void* object) {
  WhoAmIRequest* _this = reinterpret_cast< WhoAmIRequest* >(object);
  (void)_this;
}
void WhoAmIRequest::RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena*) {
}
...
// @@protoc_insertion_point(message_clear_start:sensory.api.oauth.WhoAmIRequest)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
::PROTOBUF_NAMESPACE_ID::uint8* WhoAmIRequest::_InternalSerialize(
    ::PROTOBUF_NAMESPACE_ID::uint8* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:sensory.api.oauth.WhoAmIRequest)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:sensory.api.oauth.WhoAmIRequest)
  return target;
}

size_t WhoAmIRequest::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:sensory.api.oauth.WhoAmIRequest)
  size_t total_size = 0;
...
void WhoAmIRequest::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message*to,
                      const ::PROTOBUF_NAMESPACE_ID::Message&from) {
  static_cast<WhoAmIRequest *>(to)->MergeFrom(
      static_cast<const WhoAmIRequest &>(from));
}


void WhoAmIRequest::MergeFrom(const WhoAmIRequest& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:sensory.api.oauth.WhoAmIRequest)
  GOOGLE_DCHECK_NE(&from, this);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(class_specific_copy_from_start:sensory.api.oauth.WhoAmIRequest)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
void PublicKeyRequest::InternalSwap(PublicKeyRequest* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      &keyid_, GetArenaForAllocation(),
      &other->keyid_, other->GetArenaForAllocation()
  );
}
...
inline void PublicKeyResponse::SharedCtor() {
publickey_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
keytype_ = 0;
}
