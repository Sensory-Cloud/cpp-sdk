...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_v1_2fvideo_2fvideo_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::sensory::api::v1::video::CreateEnrollmentConfig, disableserverenrollmenttemplatestorage_),
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::sensory::api::v1::video::AuthenticateConfig, _internal_metadata_),
  ~0u,  // no _extensions_
  PROTOBUF_FIELD_OFFSET(::sensory::api::v1::video::AuthenticateConfig, _oneof_case_[0]),
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  ::PROTOBUF_NAMESPACE_ID::internal::kInvalidFieldOffsetTag,
  ::PROTOBUF_NAMESPACE_ID::internal::kInvalidFieldOffsetTag,
...
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::sensory::api::v1::video::VideoModel)},
  { 13, -1, -1, sizeof(::sensory::api::v1::video::GetModelsRequest)},
  { 19, -1, -1, sizeof(::sensory::api::v1::video::GetModelsResponse)},
  { 26, -1, -1, sizeof(::sensory::api::v1::video::CreateEnrollmentRequest)},
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_v1_2fvideo_2fvideo_2eproto = {
  false, false, 2885, descriptor_table_protodef_v1_2fvideo_2fvideo_2eproto, "v1/video/video.proto", 
...
void VideoModel::InternalSwap(VideoModel* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      &fixedobject_, lhs_arena,
      &other->fixedobject_, rhs_arena
  );
...
void ValidateRecognitionRequest::SharedCtor() {
clear_has_streamingRequest();
}
...
CreateEnrollmentConfig::CreateEnrollmentConfig(const CreateEnrollmentConfig& from)
  ...
  ::memcpy(&livenessthreshold_, &from.livenessthreshold_,
    ...
    reinterpret_cast<char*>(&livenessthreshold_)) + sizeof(numlivenessframesrequired_));
...
::PROTOBUF_NAMESPACE_ID::uint8* CreateEnrollmentConfig::_InternalSerialize(
  ...
  if (!this->_internal_referenceid().empty()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      ...
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "sensory.api.v1.video.CreateEnrollmentConfig.referenceId");
    target = stream->WriteStringMaybeAliased(
...
// @@protoc_insertion_point(one_of_clear_start:sensory.api.v1.video.AuthenticateConfig)
  switch (authId_case()) {
    case kEnrollmentId: {
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 18)) {
          ...
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "sensory.api.v1.video.AuthenticateConfig.enrollmentGroupId"));
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
::PROTOBUF_NAMESPACE_ID::uint8* AuthenticateConfig::_InternalSerialize(
  ...
  if (_internal_has_enrollmentgroupid()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      ...
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "sensory.api.v1.video.AuthenticateConfig.enrollmentGroupId");
    target = stream->WriteStringMaybeAliased(
        2, this->_internal_enrollmentgroupid(), target);
  }

  // bool isLivenessEnabled = 3;
  if (this->_internal_islivenessenabled() != 0) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteBoolToArray(3, this->_internal_islivenessenabled(), target);
  }
  ...
  if (this->_internal_livenessthreshold() != 0) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteEnumToArray(
      4, this->_internal_livenessthreshold(), target);
  }
  ...
  if (this->_internal_has_compression()) {
    ...
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessage(
        5, _Internal::compression(this), target, stream);
  }
...
void ValidateRecognitionConfig::SharedCtor() {
modelname_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
userid_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
threshold_ = 0;
}
